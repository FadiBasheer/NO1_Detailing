  ...
  <header class="header">
    ...
    <nav :class="{ 'nav-open': isMenuOpen }">
      <ul>
        ...
        <!-- Services dropdown -->
        <li class="dropdown">
          <p :class="['dropdown-btn', { 'dropdown-btn-open': activeDropdown === 'services' }]" @click="toggleDropdown('services')">Services</p>
        ...
        <li class="dropdown">
          <p :class="['dropdown-btn', { 'dropdown-btn-open': activeDropdown === 'business' }]" @click="toggleDropdown('business')">Business Programs</p>
